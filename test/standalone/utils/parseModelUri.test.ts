            ...
            expect(parsedModelUri).toMatchInlineSnapshot(`
              {
                ...
                "resolvedUrl": "https://hf-mirror.com/mradermacher/Meta-Llama-3.1-8B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-8B-Instruct.Q4_K_M.gguf?download=true",
                "type": "resolved",
            ...
            expect(parsedModelUri).toMatchInlineSnapshot(`
              {
                ...
                "resolvedUrl": "https://hf-mirror.com/bartowski/Meta-Llama-3.1-70B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-70B-Instruct-Q5_K_L/Meta-Llama-3.1-70B-Instruct-Q5_K_L-00001-of-00002.gguf?download=true",
                "type": "resolved",
            ...
            expect(parsedModelUri).toMatchInlineSnapshot(`
              {
                ...
                "resolvedUrl": "https://hf-mirror.com/mradermacher/Meta-Llama-3.1-70B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-70B-Instruct.Q8_0.gguf.part1of2?download=true",
                "type": "resolved",
            ...
            expect(resolvedUri).toMatchInlineSnapshot(`
              {
                ...
                "resolvedUrl": "https://hf-mirror.com/bartowski/Meta-Llama-3.1-70B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-70B-Instruct-Q5_K_M/Meta-Llama-3.1-70B-Instruct-Q5_K_M-00001-of-00002.gguf?download=true",
                "type": "resolved",
                "uri": "hf:bartowski/Meta-Llama-3.1-70B-Instruct-GGUF:Q5_K_M",
              }
            `);
            ...
            expect(resolvedUri).toMatchInlineSnapshot(`
              {
                ...
                "resolvedUrl": "https://hf-mirror.com/mradermacher/Meta-Llama-3.1-8B-Instruct-GGUF/resolve/main/Meta-Llama-3.1-8B-Instruct.IQ3_M.gguf?download=true",
                "type": "resolved",
                "uri": "hf:mradermacher/Meta-Llama-3.1-8B-Instruct-GGUF",
              }
            `);
